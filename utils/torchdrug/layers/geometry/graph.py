...
class GraphConstruction(nn.Module, core.Configurable):
    ...
    def __init__(self, node_layers=None, edge_layers=None, edge_feature="residue_type"):
        ...
        # node_layers, edge_layers: None, [SpatialEdge()]
...
class SpatialLineGraph(nn.Module, core.Configurable):
    ...
    def forward(self, graph):
        ...
        edge_list = line_graph.edge_list
        ...
        return type(line_graph)(edge_list, num_node=line_graph.num_node,
                                num_edge=line_graph.num_edge, num_relation=self.num_angle_bin,
