...
def option_parser(args,options,lists,version=0):
    ...
    #logging.basicConfig(format='%(levelname)-7s    %(message)s',level=logLevel)   ### ls 2023.10.06
    logging.basicConfig(format='%(levelname)-7s    %(message)s',level=logLevel,filename='info_cg.log',filemode='w')
...
def map(r,ca2bb = False):
    ...
    q = [
        [(m, coord, a.index((atom, m, coord))) for atom, m, coord in a if atom in group]
        for group in p
        if any(atom in group for atom, _, _ in a)
    ]
    # Bead positions
...
class Topology:
    ...
    def __str__(self):
        ...
        out.append("; Backbone bonds")           ### ls 2023.10.06
        if bonds:
           # out.append("; Backbone bonds")      ### ls 2023.10.06
            out.extend(bonds)
        # Rubber Bands
        ...
        out.append("; Sidechain bonds")                   ### ls 2023.10.06
        if bonds:
            #out.append("; Sidechain bonds")              ### ls 2023.10.06
            out.extend(bonds)
...
if __name__ == '__main__':
    ...
    if '-cat' in args:
        ...
        sys.exit()
    # Get the possible commandline arguments and help text.
